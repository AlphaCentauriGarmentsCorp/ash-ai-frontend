export default function StatCard({
  ...
  return (
    <div className={`card border ${colorClass.border} p-4`} style={{ backgroundColor: `rgba(${color === 'green' ? '34,197,94' : color === 'orange' ? '217,119,6' : '239,68,68'}, 0.1)`, borderRadius: "1rem" }}>
