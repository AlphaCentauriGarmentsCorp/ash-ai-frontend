...
const AddSpecialPrint = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      await specialPrintApi.create(formData);
      ...
      if (err.response?.data?.errors) {
        ...
        setServerError(
          err.response?.data?.message || "Failed to create special print.",
        );
      }
    } finally {
      setIsSubmitting(false);
  ...
  return (
    ...
    >
      {submitSuccess && (
        <AlertMessage
          type="success"
          title="Special Print created successfully!"
          message="The special print has been added to the system."
        />
      )}
...
export default AddSpecialPrint;
