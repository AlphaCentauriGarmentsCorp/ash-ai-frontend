...
const AddPrintMethod = () => {
  ...
  const handleSubmit = (e) => {
    ...
    navigate("/admin/settings/print-method");
  };
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              {/* Print Method Title Field */}
              <div>
                <label 
                  htmlFor="printMethodTitle" 
                ...
                <input
                  type="text"
                  id="printMethodTitle"
                  name="printMethodTitle"
                  value={formData.printMethodTitle}
