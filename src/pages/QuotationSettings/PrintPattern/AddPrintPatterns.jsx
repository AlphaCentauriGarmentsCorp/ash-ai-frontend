...
const AddPrintPatterns = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      await printPatternsApi.create(formData);
      ...
      if (err.response?.data?.errors) {
        ...
        setServerError(
          err.response?.data?.message || "Failed to create print patterns.",
        );
      }
    } finally {
      setIsSubmitting(false);
    ...
    >
      <div className="bg-light p-3 lg:p-7 rounded-lg border border-gray-300">
        {submitSuccess && (
          <AlertMessage
            type="success"
            title="Print Patterns created successfully!"
            message="The new print patterns has been added to the system."
          />
        )}
...
export default AddPrintPatterns;
