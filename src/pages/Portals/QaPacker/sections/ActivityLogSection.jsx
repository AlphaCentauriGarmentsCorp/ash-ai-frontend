...
/**
 * Phase 7-B Bundle 2 — Activity log for the QA/Packer portal.
 *
 * Same shape as Cutter's ActivityLogSection (and every other portal's),
 * so it's visually consistent.
 *
 * Reads from `context.activity_log`, built by
 * QaPackerPortalService::recentActivity (last 10 entries from
 * stage_audit_logs scoped to this stage).
 */
...
const ActivityLogSection = ({ activityLog = [], sectionNumber = 8 }) => {
  return (
