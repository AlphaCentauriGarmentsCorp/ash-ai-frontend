...
const SampleUploadSection = ({
  ...
  const handleSubmit = async (markDone) => {
    ...
    try {
      await cutterPortalApi.createSampleUpload(
        {
          order_id: orderId,
    ...
    <section className="bg-white rounded-lg border border-gray-200 p-5">
      ...
      <div className="mb-3">
        ...
        <textarea
          ...
          placeholder="Hal. Okay ang sukat at tahi."
          disabled={submitting}
...
export default SampleUploadSection;
