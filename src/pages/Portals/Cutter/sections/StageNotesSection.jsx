...
/**
 * Cutter Rework CP2 — Notes section for the Cutter Portal.
 * (Same pattern as StageNotesSectionGA / ScreenMaker's StageNotesSection —
 * each portal keeps its own copy with role-appropriate placeholder copy.)
 *
 ...
 * saved blob (stage.notes) surfaces on the Review Hub's Cutting card.
 */
  ...
  return (
    <section className="bg-white rounded-lg border border-gray-200 p-5">
      ...
      <p className="text-xs text-gray-500 mb-2">
        May mga notes o special instructions tungkol sa pag-cut?
      </p>
      ...
      <textarea
        ...
        placeholder="Halimbawa: Manipis ang tela, dahan-dahan sa pag-cut. Sundin ang grain line."
        disabled={saving}
