...
const PrinterPortalPage = () => {
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      try {
        const result = await portalApi.myActive("printer");
        if (cancelled) return;
      ...
      <RolePortalLayout roleTitle="Sample Creation – Printer">
        <div className="bg-white border border-gray-200 rounded-lg p-8 text-center">
          ...
          <p className="text-sm text-gray-500 mb-4 max-w-md mx-auto">
            Wala ka pang in-progress na printing task. Tatawagin ka ng manager
            mo kapag may bagong sample na kailangan i-print.
          </p>
          <button
            type="button"
            onClick={() => navigate("/")}
      ...
      <RolePortalLayout roleTitle="Sample Creation – Printer">
        <div className="bg-white border border-gray-200 rounded-lg p-5">
          ...
          <p className="text-xs text-gray-500 mb-4">
            Marami kang active na printing task. Piliin kung saan ka unang magtatrabaho.
          </p>
