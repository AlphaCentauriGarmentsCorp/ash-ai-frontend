...
/**
 * Printer Rework CP2 — Notes section for the Printer Portal.
 * (Same pattern as StageNotesSectionGA / Screen Maker's / Cutter's
 * StageNotesSection — each portal keeps its own copy with role-appropriate
 * placeholder copy.)
 *
 * Wraps the existing orderStagesApi.setNotes endpoint (Phase 4).
 * Pre-populates with current stage notes; saves overwrite the field. The
 * saved blob (stage.notes) surfaces on the Review Hub's Printing card.
 */
  ...
  return (
    <section className="bg-white rounded-lg border border-gray-200 p-5">
      ...
      <p className="text-xs text-gray-500 mb-2">
        May mga notes o special instructions tungkol sa pag-print?
      </p>
      ...
      <textarea
        ...
        placeholder="Halimbawa: Naka-2 pass ang black para solid. I-double check ang registration bago mag-mass production."
        disabled={saving}
